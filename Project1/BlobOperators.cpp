...
/***************************************************************************
  Implementaci?de les classes per al càlcul de característiques sobre el blob
...
- PARÀMETRES:
- RESULTAT:
	- retorna la longitud del perímetre convex del blob. Si el blob no t?coordenades
